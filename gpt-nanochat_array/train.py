...
def main():
    ...
    SCALAR_LR = cfg["scalar_lr"]
    WEIGHT_DECAY = cfg["weight_decay"]
    ADAM_BETAS = tuple(cfg["adam_betas"])  # JSON list -> tuple
    ...
    # Helper functions (closures over config variables)
    ...
    while True:
        ...
        if math.isnan(train_loss_f) or train_loss_f > 100:
            print("FAIL")
            if args.output:
                fail_result = {"val_bpb": 999.0, "status": "diverged", "config": cfg}
